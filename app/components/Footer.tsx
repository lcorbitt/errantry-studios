...
const Footer = () => {
  return (
    <footer className="bg-black text-white/80 p-6 md:p-12 border-t border-white/10 w-full">
      <div className="flex flex-col md:flex-row justify-between items-center max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
